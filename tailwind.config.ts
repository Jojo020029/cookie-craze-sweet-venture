		...
		extend: {
			colors: {
				...
				pink: {
					...
					light: '#FFE5EA',     // Lighter pink
					medium: '#FFCAD4',    // Medium pink
					dark: '#F4ACB7'       // Darker but still soft pink
				},
				yellow: {
					lightest: '#FFFAEB',  // Very light yellow
					light: '#FFF3D8',     // Light yellow
					cream: '#FFFBF5'      // Slight adjustment to cream
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
